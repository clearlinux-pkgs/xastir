...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683311331
...
cp %{_builddir}/Xastir-Release-%{version}/COPYING.LIB.LESSTIF %{buildroot}/usr/share/package-licenses/xastir/5fb362ef1680e635fe5fb212b55eef4db9ead48f || :
cp %{_builddir}/Xastir-Release-%{version}/Davis/COPYING %{buildroot}/usr/share/package-licenses/xastir/74a8a6531a42e124df07ab5599aad63870fa0bd4 || :
cp %{_builddir}/Xastir-Release-%{version}/LaCrosse/COPYING %{buildroot}/usr/share/package-licenses/xastir/74a8a6531a42e124df07ab5599aad63870fa0bd4 || :
cp %{_builddir}/Xastir-Release-%{version}/src/LICENSE.geocoder %{buildroot}/usr/share/package-licenses/xastir/963def3115497942492836e7a36d48b95f5a5fda || :
pushd ../buildavx2/
%make_install_v3
popd
pushd ../buildavx512/
...
%defattr(-,root,root,-)
/V3/usr/bin/callpass
/V3/usr/bin/testdbfawk
/V3/usr/bin/xastir
/V3/usr/bin/xastir_udp_client
/V4/usr/bin/callpass
/V4/usr/bin/testdbfawk
/V4/usr/bin/xastir
/V4/usr/bin/xastir_udp_client
/usr/bin/callpass
/usr/bin/testdbfawk
/usr/bin/xastir
